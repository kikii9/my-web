    ...
    children: [
      {
        path: "/searchForm",
        name: "searchForm",
        component: () => import("../views/form/searchForm.vue"),
        meta: {
          requiresAuth: true, //有一些页面是否登录才能进去
          name: "搜素表单",
        },
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: "/MultipleList",
        name: "MultipleList",
        component: () => import("../views/system/MultipleList/index.vue"),
        meta: {
          requiresAuth: true,
          name: "多选表格",
        },
      },
      {
        path: "/RadioList",
        name: "RadioList",
        component: () => import("../views/system/RadioList/index.vue"),
        meta: {
          requiresAuth: true,
          name: "单选表格",
        },
    ...
    children: [
      {
        path: "/javaScript",
        name: "javaScript",
        component: () => import("../views/basic/javaScript.vue"),
        meta: {
          requiresAuth: true,
          name: "JavaScript基础知识",
        },
      },
      {
        path: "/html",
        name: "html",
        component: () => import("../views/basic/html.vue"),
        meta: {
          requiresAuth: true,
          name: "html基础知识",
        },
